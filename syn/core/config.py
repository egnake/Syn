...
ASYNC_TIMEOUT = 1.5  # Saniye cinsinden asenkron TCP bağlantı zaman aşımı
ASYNC_CONCURRENCY_LIMIT = 100  # Aynı anda açık olabilecek maksimum bağlantı sayısı
